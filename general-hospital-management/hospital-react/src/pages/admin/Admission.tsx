...
import { admissionApi, Admission } from '../../services';
...
export default function AdmissionPage() {
    ...
    const filtered: Admission[] = admissions.filter(a =>
        !search || (a.tenBenhNhan || '').toLowerCase().includes(search.toLowerCase())
    );
    ...
    return (
        <div className="admin-page">
            ...
            <div className="page-toolbar">
                <div className="toolbar-left"><input className="search-input" placeholder="🔍 Tìm bệnh nhân nhập viện..." value={search} onChange={e => setSearch(e.target.value)} /></div>
