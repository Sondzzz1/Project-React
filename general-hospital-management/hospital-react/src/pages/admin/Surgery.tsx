...
export default function SurgeryPage() {
    ...
    const filtered: Surgery[] = surgeries.filter(s =>
        !search || (s.tenBenhNhan || '').toLowerCase().includes(search.toLowerCase()) ||
    ...
    return (
        <div className="admin-page">
            ...
            <div className="page-toolbar">
                <div className="toolbar-left"><input className="search-input" placeholder="🔍 Tìm ca phẫu thuật..." value={search} onChange={e => setSearch(e.target.value)} /></div>
