...
interface SvcItem { icon: string; name: string; desc: string; price: string; }
interface SvcCategory { title: string; items: SvcItem[]; }

const serviceCategories: SvcCategory[] = [
    {
...
export default function ServicesPage() {
    return (
        <div className="services-page">
            <div className="svc-hero"><h1>Dịch vụ Y tế</h1><p>Đa dạng dịch vụ y tế chất lượng cao với đội ngũ chuyên gia hàng đầu</p></div>
