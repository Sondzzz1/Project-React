...
const slides: Slide[] = [
    { title: 'Bệnh viện Đa khoa Hoàn Mỹ', desc: 'Chăm sóc sức khỏe toàn diện với đội ngũ 150+ bác sĩ chuyên khoa', cta: 'Đặt lịch khám ngay' },
    { title: 'Trang thiết bị Y tế Hiện đại', desc: 'Hệ thống MRI 3.0 Tesla, CT Scanner 256 lát cắt, Xét nghiệm tự động', cta: 'Khám phá dịch vụ' },
    { title: 'Đội ngũ Chuyên gia Hàng đầu', desc: 'Giáo sư, Tiến sĩ, Bác sĩ chuyên khoa II từ các bệnh viện lớn', cta: 'Xem đội ngũ bác sĩ' },
];
                    ...
                    <div className="doctors-grid">
                        {doctors.map((doc, i) => (
                            <div key={i} className="doctor-card">
                                <div className="doctor-avatar">{doc.name.split(' ').pop()?.charAt(0)}</div>
                                <h3>{doc.name}</h3>
